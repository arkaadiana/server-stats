...
def background_cache_updater():
    """Meng-update cache di background setiap 2 detik"""
...
def get_fast_metrics():
    """Fungsi yang dipanggil oleh API AI untuk respon 0 detik"""
    return CACHED_METRICS

def log_for_pm2():
    while True:
        try:
            metrics = CACHED_METRICS if CACHED_METRICS else get_full_metrics()
